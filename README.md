...
Atualmente curso **Desenvolvimento de Sistemas** na **Etec Bento Quirino**. Utilizo este espaço para compartilhar meus **projetos**, estudos e minha jornada na tecnologia.

---

## 🧩 Sobre Mim
- 🎯 **Objetivo**: Me tornar um **Engenheiro de Computação**, com foco acadêmico avançado.
- 🚀 **Foco**: Desenvolvimento Full Stack, com especial interesse em **Cyber Security** e **Arquitetura de Sistemas Sustentáveis**.
- 💡 **Interesses**: IA aplicada, IoT, sistemas de monitoramento e soluções de impacto social.
...
* **Nima** – Ecossistema para adoção de animais, integrando lógica de matching comportamental e tracking via NFC/IoT.
* **Finance.hub** – Gestão financeira pessoal com dashboards analíticos, categorização de despesas e acompanhamento de investimentos.
* **Comunicar +** – Plataforma de assistência fonoaudiológica, focada em exercícios fonéticos para suporte ao desenvolvimento.
* **Aurora Base** – Projeto conceitual de arquitetura sustentável para colônia espacial com sistemas de suporte à vida.
* **ShapeTrack Pro** – Dashboard de alta performance para monitoramento de treinos, dietas (macros) e biometria.
* **Snake Moderno** – Jogo clássico recriado com design limpo, responsividade e dificuldade progressiva.
* **Projeto Educacional Multidisciplinar** – Implementação de POO em Java para modelagem de conteúdos interdisciplinares.
